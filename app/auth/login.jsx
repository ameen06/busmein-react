    ...
    return (
        <View>
            <View class="w-full min-h-screen relative">
                <Image class="w-full" source="https://images.unsplash.com/photo-1658356162600-2923b8d8bb60?q=80&w=1966&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="background image" />
            </View>

            <View class="w-full h-full absolute top-0 left-0 z-10 p-2 flex justify-center items-center">
                <View class="w-full bg-white max-w-sm rounded-xl shadow-md">
                    <View class="w-full px-6 py-8 space-y-4">
                        {/* auth page switch buttons */}
                        <View class="w-full rounded-lg border-[2px] border-blue-800 flex justify-center items-center p-0">
                            <Link class="w-full text-blue-800 font-semibold text-center px-4 py-2.5 bg-white rounded-md focus:outline-none focus:bg-blue-900">
                                SIGN UP
                            </Link>
                            <Link class="w-full text-white font-semibold text-center px-4 py-2.5 bg-blue-800 rounded-md focus:outline-none focus:bg-blue-900">
                                LOGIN
                            </Link>
                        </View>
                        ...
                        <View class="w-full space-y-4">
                            ...
                            <View class="w-full relative">
                                <View class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            ...
                            <Button type="button" onPress={()=>{console.log('pressed')}} class="w-full text-white bg-blue-800 disabled:bg-blue-600 font-semibold rounded-lg px-5 py-4 focus:outline-none uppercase inline-flex items-center justify-center gap-2" disabled={isLoading}>
                            ...
                            <View class="w-full text-center">
                                <Text class="text-blue-800 font-semibold text-sm">OR</Text>
                            </View>
                
                            {/* google facebook apple login */}
                            <View class="w-full flex justify-center items-center gap-2">
                                {/* google */}
                                <button class="w-auto rounded-full">
                                    <View class="p-2 border-2 border-blue-900 rounded-full flex justify-center items-center">
